      ...
      <Card className="border border-white/10 bg-white/3 backdrop-blur-sm transition-all hover:border-white/20 hover:bg-white/6">
        <CardContent className="px-5 py-6">
          ...
          <Button
            ...
            className="group from-primary to-secondary shadow-primary/25 relative w-full overflow-hidden rounded-xl bg-linear-to-r via-purple-500 px-4 py-6 text-sm font-bold text-white shadow-lg transition-all hover:scale-[1.02] active:scale-95"
          >
            <span className="relative z-10 flex items-center justify-center gap-2 rtl:flex-row-reverse">
              {t("upgradeToPro")}
