...
export const SubmitButtonStyles =
  "absolute top-1/2 right-3 rtl:right-auto rtl:left-3 translate-y-[-50%] cursor-pointer rounded-full bg-primary hover:bg-primary/90 text-primary-foreground p-2.5 transition-all hover:scale-110 hover:shadow-glow active:scale-95 disabled:opacity-50 disabled:cursor-not-allowed border-0";
